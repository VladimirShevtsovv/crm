...
const ButtonNewClient = (props) => {
    return (
        <div className={styles.button__newClientContainer}>
            <button className={styles.button__newClient} onClick={()=>{props.setPopUpVisibility(true)
                props.setSelectedFormInPopUp('NewClient')}}>
